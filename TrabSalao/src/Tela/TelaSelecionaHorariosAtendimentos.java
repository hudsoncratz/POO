...
public class TelaSelecionaHorariosAtendimentos extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaSelecionaHorariosAtendimentos frame = new TelaSelecionaHorariosAtendimentos("", "", 0, 0);
	...
	public TelaSelecionaHorariosAtendimentos(String nomeSalao, String servico, int i, int j) {
		initialize(nomeSalao, servico, i, j);
	 ...
	 * Create the frame.
	 */
	public void initialize(String nomeSalao, String servico, int i, int j) {
		...
		JLabel lblAgendamentoDeHorario = new JLabel("Agendamento de horario");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					b.insereAtendimento(nomeSalao, d.getDia(), d.getMes(), h.getHora(), servico);
